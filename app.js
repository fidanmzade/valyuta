...
let select = document.querySelector(".currencyofcountry");
...
function selectCurrency(e) {
  ...
  if (targetSpace.parentElement.className.indexOf("money-from") !== -1) {
    targetSpace.setAttribute("style", "background: #833AE0;color:#fff");
    from = targetSpace.textContent;
    getDataFrom();
  } else if (targetSpace.parentElement.className.indexOf("money-to") !== -1) {
    targetSpace.setAttribute("style", "background: #833AE0;color:#fff");
